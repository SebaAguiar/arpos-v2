# Estrategia de Testing — Arcom Tauri v2

Este documento define cómo escribir y estructurar tests en Arcom, incluyendo unit tests, integration tests y E2E tests.
...
import { PrismaService } from '@arcom/prisma';

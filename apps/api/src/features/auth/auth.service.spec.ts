...
describe('AuthService', () => {
  ...
  describe('validateUser', () => {
    it('should return user payload when credentials are valid', async () => {
      ...
      const result = await service.validateUser('admin@arpos.com', 'password123');
    ...
    it('should return null when user not found', async () => {
      ...
      const result = await service.validateUser('nobody@arpos.com', 'pass');
    ...
    it('should return null when password is invalid', async () => {
      ...
      const result = await service.validateUser('admin@arpos.com', 'wrongpassword');
      expect(result).toBeNull();
    });
  });
